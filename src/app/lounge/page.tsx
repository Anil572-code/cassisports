      ...
      <section className="py-16 bg-gradient-to-r from-amber-600 to-orange-700">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-amber-700 font-bold rounded-lg text-base transition-all duration-300 hover:bg-amber-50 hover:shadow-xl"
            >
              Reserve a Table
            </Link>
            <a
