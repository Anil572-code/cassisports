        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            ...
            <div className="relative">
              <div className="h-80 sm:h-96 bg-gradient-to-br from-brand-teal/20 to-brand-orange/20 rounded-3xl flex items-center justify-center border border-gray-100 shadow-xl">
