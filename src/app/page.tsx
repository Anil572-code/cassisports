...
export const metadata: Metadata = {
  title: "Home",
  description:
    "Cassi Sports & Recreational Center Pvt. Ltd. offers premium indoor sports facilities, futsal, cricsal, swimming, and the Cassi Lounge & Sports Bar for champions in Pune.",
};
  ...
  return (
    <>
      ...
      <section className="relative min-h-screen flex items-center justify-center bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 text-center py-24 sm:py-28 lg:py-32">
          ...
          <h1 className="text-4xl sm:text-5xl md:text-6xl lg:text-7xl font-black text-white leading-tight tracking-tight text-balance mb-5 sm:mb-6">
            Where Champions{" "}
          ...
          <p className="text-base sm:text-lg md:text-xl text-gray-300/90 max-w-3xl mx-auto mb-10 leading-relaxed">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link href="/facilities" className="btn-primary text-base px-8 py-4 w-full sm:w-auto">
              🏟️ Explore Facilities
            </Link>
            <Link href="/lounge" className="btn-outline-teal text-base px-8 py-4 w-full sm:w-auto">
              🍹 Visit Lounge
            </Link>
          </div>
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-gray-900 mb-6 leading-tight tracking-tight">
            ...
            <div className="relative">
              <div
                className="h-80 sm:h-96 bg-gradient-to-br from-brand-teal/20 to-brand-orange/20 rounded-3xl flex items-center justify-center border border-gray-100 shadow-xl"
                data-placeholder="feature-image"
                aria-label="Safety highlight image placeholder"
              >
              ...
              <div className="absolute -bottom-3 sm:-bottom-4 -right-3 sm:-right-4 w-24 sm:w-28 h-24 sm:h-28 bg-brand-orange rounded-2xl flex items-center justify-center shadow-lg">
                <div className="text-center">
      ...
      {/* Cassi Lounge Teaser */}
      <section className="py-20 sm:py-24 bg-gradient-to-br from-brand-dark via-slate-800 to-slate-900 relative overflow-hidden">
          ...
          <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
            <div>
              ...
              <div className="flex flex-col sm:flex-row gap-4">
                <Link href="/lounge" className="btn-primary w-full sm:w-auto">
            ...
            <div className="grid grid-cols-2 gap-4">
              {[
                ...
                <div
                  key={item.label}
                  className="glass rounded-2xl p-5 sm:p-6 flex flex-col items-center gap-3 hover:bg-white/20 transition-all duration-200 hover:-translate-y-1"
                >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-6">
            {whyChooseUs.map((item) => (
              <div
                key={item.title}
                className="text-center p-5 sm:p-6 rounded-2xl bg-gray-50 border border-gray-100 card-hover group hover:bg-brand-orange/5 hover:border-brand-orange/20"
              >
        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-2 md:grid-cols-3 gap-4 sm:gap-5">
            {galleryGradients.map((grad, i) => (
              <div
                key={i}
                className={`relative h-40 sm:h-48 md:h-64 bg-gradient-to-br ${grad} rounded-2xl overflow-hidden cursor-pointer group transition-transform duration-300 hover:scale-[1.02]`}
                data-placeholder="gallery-image"
                aria-label={`${galleryLabels[i]} image placeholder`}
              >
      ...
      {/* Contact CTA Banner */}
      <section className="py-14 sm:py-16 bg-gradient-to-r from-brand-orange to-orange-600">
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
          <h2 className="text-2xl sm:text-3xl md:text-4xl font-black text-white mb-4 leading-tight tracking-tight">
          ...
          <div className="flex flex-col sm:flex-row gap-4 justify-center">
            <Link
              href="/contact"
              className="inline-flex items-center justify-center px-8 py-4 bg-white text-brand-orange font-bold rounded-lg text-base transition-all duration-300 hover:bg-orange-50 hover:shadow-xl hover:-translate-y-0.5 w-full sm:w-auto focus:outline-none focus:ring-2 focus:ring-white/80 focus:ring-offset-2 focus:ring-offset-brand-orange"
            >
              Book Now
            </Link>
            <a
              href="https://wa.me/919123456789"
              className="inline-flex items-center justify-center gap-2 px-8 py-4 border-2 border-white text-white font-bold rounded-lg text-base transition-all duration-300 hover:bg-white/10 hover:shadow-lg hover:-translate-y-0.5 w-full sm:w-auto focus:outline-none focus:ring-2 focus:ring-white/80 focus:ring-offset-2 focus:ring-offset-brand-orange"
            >
